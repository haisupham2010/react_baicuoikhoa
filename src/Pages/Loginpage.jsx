...
export default function Loginpage() {
  ...
  return (
    <div className="d-flex align-items-center justify-content-center bg-dark-subtle" style={{ height: "600px" }}>
      {/* thay đổi 1 */}
      <div className="container d-flex align-items-center justify-content-center mt-5 mb-5 bg-white" style={{ height: "500px" }} >
