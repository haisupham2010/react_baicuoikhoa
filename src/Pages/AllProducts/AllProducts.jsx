    ...
    <div className="d-flex container">
      <div className="w-75 pb-5 pe-5 ps-5">
        <div className="d-flex">
          <div>
            <Link to="/react_baicuoikhoa/" className="nav-link active">
              Home&nbsp;
            </Link>
          </div>
            ...
            {displayPage.map((product) => (
              <div className="col-4 g-2" key={product.id}>
                ...
                <Link
                  ...
                  to={`/react_baicuoikhoa/${product.id}`}
                >
                  {" "}
                  {`${product.name}`}
                </Link>
      ...
      <aside className="w-25 p-4 mt-1 bg-body">
        ...
        <Link className="nav-link" to="/react_baicuoikhoa/all-products/decoration">
        ...
        <Link className="nav-link" to="/react_baicuoikhoa/all-products/frame&poster">
          <div className="d-flex align-items-center mt-3 border-bottom pb-3">
        ...
        <Link className="nav-link" to="/react_baicuoikhoa/all-products/funiture">
          <div className="d-flex align-items-center mt-3 border-bottom pb-3">
        ...
        <Link className="nav-link" to="/react_baicuoikhoa/all-products/pillows">
          <div className="d-flex align-items-center mt-3 border-bottom pb-3">
