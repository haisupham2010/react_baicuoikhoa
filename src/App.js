                          ...
                          <div className="nav_boder position-relative" >
                            ...
                            <ul className="navbar-nav nav_wight d-flex align-items-center justify-content-center">
                              ...
                              <li className="nav-item me-3" >
                                <Link onClick={handl_navhome} to="/react_baicuoikhoa/" className="nav-link active" aria-current="page" >
                              ...
                              <li className="nav-item me-3">
                                <Link to="/react_baicuoikhoa/about-us" onClick={handl_navabout} className="nav-link" >
                              ...
                              <li className="nav-item me-3">
                                <Link to="/react_baicuoikhoa/contact" onClick={handl_navcontact} className="nav-link">
                              ...
                              <li className="nav-item me-3">
                                <Link to="/react_baicuoikhoa/cart" onClick={handl_navyourcard} className="nav-link" style={{ color: "black" }}>
